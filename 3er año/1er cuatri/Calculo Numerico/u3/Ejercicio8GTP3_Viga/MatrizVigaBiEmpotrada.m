function [A,Afull, b, x0] = MatrizVigaBiEmpotrada(Nh, L, fj)
  # Armamos la matriz del ejercicio Nro 9 de la viga empotrada

  h = L/Nh; # subintervalos del dominio discreto.

  # armamos los vectores para generar luego los diagonales primarias y secundarias
  d0 = 6*ones(Nh-3,1); % diagonal principal
  d1 = -4*ones(Nh-4,1); % primera diagonal secundaria
  d2 = ones(Nh-5,1); % segunda diagonal secundaria

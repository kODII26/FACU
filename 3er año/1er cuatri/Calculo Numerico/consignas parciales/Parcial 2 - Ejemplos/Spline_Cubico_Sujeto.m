...
v(2:n-1) = 3 * ( (y(3:n)-y(2:n-1) ) ./ h(2:n-1) -( y(2:n-1) - y(1:n-2) ) ./ h(1:n-2));#paso3
v(n) = 3*( dyn - ( y(n) - y(n-1) ) / h(n-1) ); # paso 2

# de aca en adelante resolvemos un sistema lineal tridiagonal utilizando un m�todo
# que vimos en M�todos Directos, Crout optimizado para matrices tridiagonales.

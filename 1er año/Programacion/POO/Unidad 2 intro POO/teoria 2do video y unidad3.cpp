...
int main() {
	...
	cout<<"El equipod de voleybol "<<f.VerNombre(nomV)<<", en la localidad de "
		<<f.VerLocalidad("Rincon")<<" posee una cantidad de "
		<<f.VerCantJugadores(cantJV)<<" jugadores y su promesa es "<<f.VerPromesa("Duki")<<endl;
	return 0;
}

...
# Aca cambiar por OR_90_trn.csv
with open('OR_50_trn.csv', mode='r', encoding='utf-8') as archivo:
...
# Aca cambiar por OR_90_tst.csv
with open('OR_50_tst.csv', mode='r', encoding='utf-8') as archivo:
    lector = csv.reader(archivo)
    for fila in lector:
        x1, x2, yd = map(float, fila)
